...
class test_decryption():
    ...
    def __init__(self):
        ...
        self.private_key = open("./test_data/rsa_private_key_sk.pem", )
        self.public_key = open("./test_data/rsa_public_key_pk.pem")'''
        print(len(
    ...
    def decrypt_models(self):
        ...
        with open("C:/Users/fboet/PycharmProjects/pht-offline-tool/test_data/encr_sym_key", "rb") as encr_sym_key:
            ...
            print("symkey read")
            priv_key = encryption_func.load_private_key("C:/Users/fboet/PycharmProjects/pht-offline-tool/test_data/rsa_private_key_sk.pem")
